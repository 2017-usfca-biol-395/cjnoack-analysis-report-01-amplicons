...
Next, from the raw data, we used DADA2  and phyloseq [@mcmurdie2013].
...
Error models (line 134-138) Visualized (line 140-145)
...
After trimming in DADA2 and denoising, the histogram shows a strong skew to the right with most sequences were around 220-225 bp. The lower range of sequences were below 220 bp. 

Sequence table with no chimeras: 
